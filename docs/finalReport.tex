...
\begin{document}
    ...
    These are requirements taken from initial discussions with the stakeholder (our supervisor),
    and interpretations of the problem statement.
    They represent our original set of requirements, with minimal implementation details, and domain knowledge.
    ...
    \begin{longtable}{|l|p{2.6cm}|l|p{4.5cm}|c|}
        ...
        \hline
        2 & C2KA Specifications & Functional & U2C shall interpret given inputs to derive a complete C2KA specification. & \cellcolor{green!30}  \\
        \hline
