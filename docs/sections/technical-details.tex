...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{manucellCollab}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.55]{abs_manucell}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{supportedStateElems.drawio}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{Atomicbehavior}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{transitions}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{SequentialBehavior}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{issueSample}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{issueTypes}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.1\textwidth]{testPipeline.drawio}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.38]{outputDiff}
...
The Table~\ref{tab:test-strat-table} traces user requirements to our testing strategy concepts, refining them in this section.
\begin{table}[htbp]
    \centering
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{systemTestSuccess}
...
\begin{figure}[p!]
    \centering
    \includegraphics[width=1\textwidth]{export-3}
    \caption{Step 3, Select an output directory, and optionally unneeded files.}
    \label{fig:export-3}
\end{figure}
\clearpage % IDK how this works but this does exactly what I want
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{iiat-out-1}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{iiat-out-2}
