    ...
    The demonstration will be using inputs generated to simulate the system from the Manufacturing Cell example system.% TODO: inlcude appendix or reference?
    ...
    \subsubsection{Running the target Model Checker, IIAT}
